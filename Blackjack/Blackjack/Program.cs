...
namespace Blackjack
{
    public class Program
    {
        ...
        private static void DealToPlayer(IDeck deck, IHand playerHand)
        {
            playerHand.AddCard(deck.DrawCard());
            Console.WriteLine("Player's hand: " + playerHand);
        }

        private static void DealToDealer(IDeck deck, IHand dealerHand)
        {
            dealerHand.AddCard(deck.DrawCard());
            Console.WriteLine("Dealer's hand: " + dealerHand);
        }

        private static void DisplayPlayCommands()
        {
            Console.WriteLine("Press 3 to hit");
            Console.WriteLine("Press 4 to stand");
        }

        private static void DealHand(IDeck deck, IHand playerHand, IHand dealerHand)
        {
            dealerHand.AddCard(deck.DrawCard());
            playerHand.AddCard(deck.DrawCard());
            dealerHand.AddCard(deck.DrawCard());
        ...
        private static void DisplayHand(IHand playerHand, IHand dealerHand)
        {
            Console.WriteLine("Player's Hand: " + playerHand);
        ...
        private static string DisplayPlayCmd()
        {
